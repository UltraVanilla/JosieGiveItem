...
group = "josie.giveitem"
version = "1.0.0"
description = "Plugin that provides various commands for accessing URLs and info about the server, as well as a `/login` command to create an account-linked token on a MariaDB database."
...
paper {
    ...
    //
    // ```kotlin
    // name = "JosieGiveItemFork"
    // provides = listOf("JosieGiveItem")
